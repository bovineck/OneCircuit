...
; to change the nature of the candle flicker
  ...
  .equ SLL = 15          ; lowest slow start
  .equ SLH = 40          ; highest slow start
  .equ SHL = 150         ; lowest slow end
  .equ SHH = 220         ; highest slow end
  .equ FLL = 100         ; lowest fast start
  .equ FLH = 140         ; highest fast start
  .equ FHL = 180         ; lowest fast end
  .equ FHH = 220         ; highest fast end
